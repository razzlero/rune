...
Create a task for each plan step before writing any code (e.g., TaskCreate in Claude Code, or your own tracker). Mark each in-progress when starting, completed when done.
